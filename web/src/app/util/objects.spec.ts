...
describe('Objects Specmate', () => {
    it('should return undefined if both objects are undefined', () => {
        const o1: IContainer = { ___nsuri: 'string', url: '', className: 'string', id : '1', name : 'weeds', description : 'this is weeds' };
    ...
    it('should throw an new error if the objects type is differnt', () => {
        const o1: IContainer = { ___nsuri: 'string', url: '12', className: 'string', id : '1', name : 'weeds', description : 'this is weeds' };
        const o2 = { name: 'd' };
    ...
    it('should return array if the objects has the changed fields', () => {
        const o1: IContainer = { ___nsuri: 'string', url: '12', className: 'string', id : '1', name : 'weeds', description : 'this is weeds' };
        const o2: IContainer = { ___nsuri: 'string', url: '12', className: 'string', id : '2', name : 'weeds', description : 'this is weeds' };
